...
<div class="center">
	...
	<div class="content">
		<div class="login_text_box" style="width:500px; text-align:center; float:none; margin-left:auto; margin-right:auto">
			<font size="6">CUSTOMER</font><font size="6" style="font-weight:normal"> DELETE</font>
		</div><br><br>
		...
		<br>
		<form action="CustomerRemove" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center" method="post">
		...
		<form action="customers.jsp" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center">
			<button "type="submit" class="login_submit" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center">
			NO
			</button><br><br><br>
		</form>
