...
<div class="center">
	...
	<div class="content">
		...
		<div class="login_text_box" style="width:100px; text-align:center; float:right">
			<font size="6"><a href="carsadd.jsp" style="color:white;text-decoration:none">ADD</a></font>
		</div>
		<br><br><br><br>
		...
		<table style="float:left">
			...
			try {
				  String query = "SELECT CUSTOMER.LAST_NAME,CAR.MAKE,CAR.MODEL,CAR.YEAR,CAR.COLOR,CAR.LICENSE,CAR.STATE,CAR.VIN FROM CUSTOMER,CAR WHERE CUSTOMER.LAST_NAME='" + lastname + "' AND CAR.CUSTOMERID like CUSTOMER.CUSTOMERID";
