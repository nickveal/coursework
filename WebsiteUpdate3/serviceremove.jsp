...
<div class="center">
	...
	<div class="content">
		<div class="login_text_box" style="width:500px; text-align:center; float:none; margin-left:auto; margin-right:auto">
			<font size="6">SERVICE</font><font size="6" style="font-weight:normal"> DELETE</font>
		</div><br><br>
		<div class="login_text_box" style="width:300px; text-align:center; float:none; margin-left:auto; margin-right:auto">
			...
			Serivce Entry #<%=request.getParameter("serviceid")%>
		</div>
		<br>
		<form action="ServiceRemove" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center" method="post">
			<button "type="submit" class="login_submit" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center">
			<font color="red">YES</red>
			</button><br><br>
		</form>
		<form action="services.jsp" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center">
			<button "type="submit" class="login_submit" style="top:10px; margin-left:auto; margin-right:auto; float:none; text-align:center">
			NO
			</button><br><br><br>
		</form>
