...
<div class="center">
	...
	<div class="content">
		<div class="login_text_box" style="width:500px; text-align:center; float:none; margin-left:auto; margin-right:auto">
			<font size="6">CAR</font><font size="6" style="font-weight:normal"> ADD</font>
		</div>
		<div class="login_text_box" style="width:auto; text-align:center; float:none; margin-left:auto; margin-right:auto">
			<font size="3" style="font-weight:normal">Last Name: </font>
			<font size="3"><%=request.getParameter("lastname")%></font>
		</div>
		<br>
		<form action="CarAdd" method="POST">
			<table style="float:left">
				...
				<tr>
					...
					<td>
						<input name="VIN" style="top:0px; font-size:15px; width:400px;" class="login_input_box" value=""/>
					</td>
				</tr>
