...
public class ServiceEdit extends HttpServlet {
		...
		throws ServletException, IOException {
            ...
            String query = "UPDATE SERVICE SET SERVICENAME='" + servicename + "',PRICE=" + price + ",COMPLETED=" + completed + ",VIN='" + vin + "' WHERE SERVICEID=" + serviceid;
			...
			if(!error) {
				out.println("Service entry edited successfully!<br>");
			}
			response.setHeader("Refresh", "3; URL=services.jsp");
		}
