...
<div class="center">
	...
	<div class="content">
		...
		<form action="carssearch.jsp">
			<input name="lastname" style="top:5px;" class="login_input_box" value="<%if(request.getParameter("lastname") != null) { out.println(request.getParameter("lastname"));}%>"/>
		...
		<table style="float:left">
			...
			try {
				  String query = "SELECT CUSTOMER.LAST_NAME,CAR.MAKE,CAR.MODEL,CAR.YEAR,CAR.COLOR,CAR.LICENSE,CAR.STATE,CAR.VIN FROM CUSTOMER,CAR WHERE CAR.VIN='" + VIN + "' AND CAR.CUSTOMERID like CUSTOMER.CUSTOMERID";
		...
		<div class="login_text_box" style="width:350px; text-align:center; float:left">
			<font size="5"><a href="servicesadd.jsp?VIN=<%=VIN%>" style="color:white;text-decoration:none">ADD NEW SERVICE</a></font>
		</div>
	</div>
</div>
